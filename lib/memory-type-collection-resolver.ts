 ...
 */
export function sanitizeCollectionName(input: string, prefix = "memory_"): string {
  // normalize
...
export function resolveCollectionName(
  ...
  try {
    if (registry && typeof registry.getByName === "function") {
      ...
      if (conf && typeof conf.collection === "string" && CollectionNameRegex.test(conf.collection)) {
