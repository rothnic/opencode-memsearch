 ...
 */
export function getJaccardSimilarity(s1: string, s2: string, n: number = 3): number {
  if (s1 === s2) return 1.0;
  if (s1.length === 0 || s2.length === 0) return 0.0;
 ...
 */
export function getCosineSimilarity(s1: string, s2: string, n: number = 3): number {
  if (s1 === s2) return 1.0;
  if (s1.length === 0 || s2.length === 0) return 0.0;
 ...
 */
export function checkSimilarity(s1: string, s2: string, threshold: number = 0.85): boolean {
